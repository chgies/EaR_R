...
class EmotionV50(nn.Module):
    """
    The feature-reduced version of the Neural Net model that gets emotions out of Video data.
    This Model includes all features that make up to 50% importance, measured with Random Forest Classifier (see CAER_model_training.py)
    Still a test version!
    """
    def __init__(self, input_size, hidden_size, output_size):
        super(EmotionV50, self).__init__()
